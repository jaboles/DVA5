    ...
    public void show(boolean showCloseButton, boolean introSound, boolean fade) {
        if (introSound)
        {
            ...
            try {
                ...
                startSoundList.add(new URL("jar:"+new File("DVA.jar").toURI().toURL()+"!/resources/start4-CHIME.mp3"));
                startSoundList.add(new URL("jar:"+new File("DVA.jar").toURI().toURL()+"!/resources/start4-D.f.mp3"));
                startSoundList.add(new URL("jar:"+new File("DVA.jar").toURI().toURL()+"!/resources/start4-V.f.mp3"));
                startSoundList.add(new URL("jar:"+new File("DVA.jar").toURI().toURL()+"!/resources/start4-A.f.mp3"));
                startSoundList.add(new URL("jar:"+new File("DVA.jar").toURI().toURL()+"!/resources/start4-5.f.mp3"));
